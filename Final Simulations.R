...
OutcomeList <- data.frame(rbind('bal_5', 'monthly_income_5', 'monthly_spending_5', 
                                'MPC_5', 'ave_vol_out_5', 
                                'food_exp_5'))
...
colnames(storage.matrix_te_fem) <- c("Assignment", "Gender", 
                                     "Wallet Balance", 
                                     "Monthly Income", "Monthly Spending", "MPC", "Ave Trade",  
                                     "Food")
...
p6 <- plot_outcome("Food", "Total Food Expenditure (USD)", "Total Food Expenditure - Prediction")
...
t6 <- plot_te("Food", "Total Food Expenditure (USD)", "Total Food Expenditure - Treatment Effect")

ggsave(filename="/Users/rebeccamqamelo/Desktop/RCT/Predictions/graph_1.pdf", 
       ggarrange(p1, t1, p2, t2, p3, t3,  
                 ncol=2, nrow=3, common.legend=TRUE, legend="bottom"),
       width = 8, height = 11)

ggsave(filename="/Users/rebeccamqamelo/Desktop/RCT/Predictions/graph_2.pdf", 
       ggarrange(p4, t4, p5, t5, p6, t6,
                 ncol=2, nrow=3, common.legend=TRUE, legend="bottom"), 
       width = 8, height = 11)